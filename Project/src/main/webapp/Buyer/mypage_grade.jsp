...
<link href="<c:url value='/resources/css/Common/sub_main.css?after'/>"
	rel="stylesheet" />
<link
	href="<c:url value='/resources/css/Buyer/mypage_grade.css?after'/>"
	rel="stylesheet" />
<title>나의 등급</title>
</head>
<body>
						...
						<article id="myPage">
							...
							<div class="my_grade--grade">
								<div class="grade-desc">
									<c:set var="cumulative_amount"
										value="${user.cumulative_amount}" />
									<dl>
										<dt class="cumulativeAmount">누적 구매금액 / 10</dt>
										<dd class="amount">${cumulative_amount}원<span
												class="text-lighter"> / 10</span>
										</dd>
									</dl>
