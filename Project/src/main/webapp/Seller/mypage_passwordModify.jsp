...
<link href="<c:url value='/resources/css/Common/sub_main.css'/>"
	rel="stylesheet" />
<link href="<c:url value='/resources/css/Seller/mypage_template.css?after'/>"
	rel="stylesheet" />
<link href="<c:url value='/resources/css/Seller/mypage_passwordModify.css?after'/>" rel="stylesheet" />
<title>프로필 수정</title>
</head>
<body>
					...
					<section id="content">
						...
						<section id="myPage">
							...
							<article class="update__form--seller">
								<h5><b>비밀번호 변경</b></h5>
								<form name="update__form--seller" id="modify__password--form" action="UpdateSellerPassword.se" method="post" >
	...
	<script type="text/javascript" src="<c:url value='/resources/js/Seller/mypage_passwordModify.js?after'/>"></script>
