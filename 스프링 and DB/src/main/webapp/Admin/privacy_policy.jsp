...
<!-- contents -->
		<section id="contents">
			...
			<div class="terms_wrap">
				<p class="terms_cont">
					이웃#은 이용자의 정보를 소중하게 생각하며, [정보통신망 이용 촉진 및 정보보호 등에 관한 법률][개인정보보호법][통신비밀보호법]등 관련법규를 준수하기 위하여 <span class="color_05">[개인정보 취급방침]</span>을 제정하고 이를 준수하고 있습니다.<br />
					이웃# 개인정보보호정책은 정부의  지침 변경 및 수정 등의 이유로 변경될 수 있으므로 회원님께서는 홈페이지 방문 시 수시로 확인하여 주시기 바랍니다.
				</p>
				...
				<p class="terms_cont">
					...
					② 이웃# (이하 “당사”라 합니다) 는 소중한 회원의 개인정보를 안전하게 처리하기 위하여, [정보통신망 이용촉진 및 정보보호 등에 관한 법률]및[개인정보보호법]등 개인정보보호 관련 법령을 준수하고 있으며 개인정보취급방침을 통하여 회원께서 제공하시는 개인정보가 어떠한 용도와 방식으로 이용되고 있으며 개인정보보호를 위해 어떠한 조치가 취해지고 있는지 알려드립니다.<br />
