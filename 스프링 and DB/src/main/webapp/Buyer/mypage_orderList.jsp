                            ...
                            <article id="transaction__detail">
                                      		            ...
                                      		            <div class="order_list__detail-info--btn">
                                      		                <c:if test='${orderList.status eq "결제확인중" || orderList.status eq "상품준비중" || orderList.status eq "배송준비중"}'>
                                      		                    ...
                                      		                    <input type="button" value="배송정보" 
                                      		                        onclick="orderDelivery('${orderList.order_id}', '${orderList.board_id}', '${orderList.order_delivery}', '${orderList.order_invoicenum}');" />
                                      		                </c:if>
                                ...
                                <div id="modal">
                                    <div id="modal-content">
                                        <input type="button" value="x" id="modal-close" 
                                            onclick="modal_close();" />
                                        <p id="modal-title">배송 조회</p>
                                        <div id="modal__delivery--info">
                                            <div class="modal__delivery--subject">택배회사</div>
                                            <div class="modal__delivery--content"></div>
                                            <div class="modal__delivery--subject">운송장 번호</div>
                                            <div class="modal__delivery--content"></div>
                                        </div>
                                        
                                        <div id="modal__delivery--table">
