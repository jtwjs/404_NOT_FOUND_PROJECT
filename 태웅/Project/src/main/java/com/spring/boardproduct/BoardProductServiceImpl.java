...
public class BoardProductServiceImpl implements BoardProductService {
	...
	public ArrayList<BoardProductVO> getBoardList_category1(int category_1, int sort_list, int page_num,
			int page_amount) {
	...
	public ArrayList<BoardProductVO> getBoardList_category2(int category_2, int sort_list, int page_num,
			int page_amount) {
	...
	public ArrayList<BoardProductVO> getBoardList_categoryLocal(int category_local, int sort_list, int page_num,
			int page_amount) {
	...
	@Override
	public ArrayList<BoardProductVO> getSearchBoardProductList(String keyword, int minCategory_1, int maxCategory_1,
			int minCategory_2, int maxCategory_2, int minCategory_local, int maxCategory_local, int min_price,
			int max_price, int sort_list, int page_num, int page_amount) {

		BoardProductMapper boardProductMapper = sqlSession.getMapper(BoardProductMapper.class);
		ArrayList<BoardProductVO> result = boardProductMapper.getSearchBoardProductList(keyword, minCategory_1,
	...
	public ArrayList<BoardReviewVO> getBoardReviewList(String board_id, int page_num, int page_amount) {
		...
		BoardReviewMapper boardReviewMapper = sqlSession.getMapper(BoardReviewMapper.class);
		ArrayList<BoardReviewVO> result = boardReviewMapper.getBoardReviewList(board_id, page_num, page_amount);
	...
	public ArrayList<BoardQnaVO> getBoardQnaList(String board_id, int qna_status, int answer_status, int page_num,
			int page_amount, String keyword) {

		BoardQnaMapper boardQnaMapper = sqlSession.getMapper(BoardQnaMapper.class);
		ArrayList<BoardQnaVO> result = boardQnaMapper.getBoardQnaList(board_id, qna_status, answer_status, page_num,
				page_amount, keyword);

		return result;
	}

	public int getBoardQnaListCount(String board_id, int qna_status, int answer_status, String keyword) {

		BoardQnaMapper boardQnaMapper = sqlSession.getMapper(BoardQnaMapper.class);
		int result = boardQnaMapper.getBoardQnaListCount(board_id, qna_status, answer_status, keyword);
	...
	public ArrayList<BoardProductVO> getSellerBestList(String seller_id, String board_id) {
		...
		BoardProductMapper boardProductMapper = sqlSession.getMapper(BoardProductMapper.class);
		ArrayList<BoardProductVO> result = boardProductMapper.getSellerBestList(seller_id, board_id);
		return result;
	}
	...
	public ArrayList<BoardProductVO> selectProductListBySellerId2(String seller_id, int rowStart, int rowEnd,
		...
		ArrayList<BoardProductVO> list = mapper.selectProductListBySellerId2(seller_id, rowStart, rowEnd, startDate,
				endDate);
		return list;
	}
	...
	public int getRegistChartData(String startSearch, String endSearch) {

		BoardProductMapper boardProductMapper = sqlSession.getMapper(BoardProductMapper.class);
		int result = boardProductMapper.getRegistChartData(startSearch, endSearch);
		return result;
	}
