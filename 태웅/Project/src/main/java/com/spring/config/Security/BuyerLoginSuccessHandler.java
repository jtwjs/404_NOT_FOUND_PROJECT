...
@Configuration
public class BuyerLoginSuccessHandler extends SavedRequestAwareAuthenticationSuccessHandler{
	...
	public void onAuthenticationSuccess(HttpServletRequest request,
		...
		System.out.println("Test1:실행완료 id="+((User) authentication.getPrincipal()).getUsername());
