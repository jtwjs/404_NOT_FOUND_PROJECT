			...
			<div class="row">
				<div class="col-xs-12">
					<section id="content">
						...
						<section id="myPage">
							<h2 class="content-title">배송지 등록</h2>
							<form name="update__form--listdelivery"
								id="insert__listdelivery--form" action="ListDeliveryWrite.by"
								method="post">
								<input type="hidden" name="${_csrf.parameterName}"
									value="${_csrf.token}" />
								<div class="contnt__deliveryrwrite">
									<div class="site_content1">
										<h4 class="content-title--site">나의 배송지 등록</h4>
										<span class="content-pp">자주 쓰는 배송지를 등록 하실 수 있습니다.</span>
									</div>

									<div class="site_content2">
										<!-- <form action="mypage_deliveryManager_write.by" method="post"> -->
										<table class="settingwrite_forms">
											<thead class="setting_form--write">
												<tr>
													<td class="form_tD" id="deliveryName_td">배송지명</td>
													<td><input type="text"
							...
							<div class="delivery_btn">
								<button type="button" class="listdelivery_success"
									id="submitBtn">등록</button>
								<input type="reset" class="listdelivery_warning" value="다시작성"
									onclick="location.href='ListDeliveryWriteForm.by'">
