...
<link href="<c:url value='/resources/css/Common/sub_main.css?after'/>"
	rel="stylesheet" />
<link
	href="<c:url value='/resources/css/Buyer/mypage_infoModify.css?after'/>"
	rel="stylesheet" />
<title>프로필 수정</title>
</head>
<body>
					...
					<section id="content">
						...
						<section id="myPage">
							...
							<article class="update__form--customer">
								...
								<form name="update__form--customer" id="update__profile--form"
									action="UpdateBuyerAccount.by" method="post"
									...
									<div class="update_profile-photo">
										<div id="update_profile-showingPart">
											...
											<dl>
												<dt>
													<img
														src="display?path=${user.profileImgPath}&name=${user.profileImg}"
														id="profile_thumbnail" alt="profile photo" />
												</dt>
												<dd>
										...
										<div id="update_profile-hidePart">
											<div class="profile_hidePart-change">
												<label for="change-photo">사진 선택</label> <input type="file"
													id="change-photo" class="hide" name="profileImg"
													accept=".gif, .jpg, .png" /> <input type="hidden"
													id="thumbnail_Value"
													value="display?path=${user.profileImgPath}&name=${user.profileImg}" />
									...
									<div class="update_name">
										<label for="userName" class="essential">이름</label> <input
											type="hidden" class="hiddenName" id="userName" name="name"
											value="${user.name }" />${user.name }
									</div>

									<div class="update_id">
										<label for="userId" class="essential">아이디</label> <input
											type="hidden" class="hiddenId" id="userId" name="id"
											value="${user.id }" />${user.id }
									</div>

									<div class="update_email">
										<label for="email1" class="virtual">이메일 주소</label> <input
											type="text" class="inputEmail1" id="email01" name="emailId"
											size="20" maxlength="20" value="${user.emailId }">
										&#64; <input type="text" class="inputEmail2" id="email02"
											name="emailAddr" size="20" maxlength="20"
											value="${user.emailAddr }"> <select
											class="selectEmail3" name="selectEmail3" id="email03">
									...
									<div class="update_mPhone">
										<label for="mPhone1" class="essential">휴대폰번호</label> <select
											class="selectPhone" id="mPhone1" name="telCarrierNum">
										...
										</select> - <input id="mPhone2" class="inputPhone2"
											name="telAllocationNum" type="text"
											value="${user.telAllocationNum }" size="4" maxlength="4">
										- <input id="mPhone3" class="inputPhone3"
											name="telDiscretionaryNum" type="text"
											value="${user.telDiscretionaryNum }" size="4" maxlength="4">

										<input type="checkbox" class="inputChkSms" name="chk_sms"
											id="sms_button"> SMS를 수신하겠습니다.

										<div class="smsAgree">
											<br />*SMS 수신에 동의하시면 여러가지 할인혜택과 각종 이벤트 정보를 받아보실 수 있습니다. <br />회원가입관련,
											주문배송관련 등의 SMS는 수신동의와 상관없이 구매 회원에게 발송됩니다.
										</div>
									</div>
									<div class="update_finish">
										...
										<button type="button" id="resetBtn"
											onclick="location.href='BuyerMyPage.by'">취소</button>
									</div>
								</form>
							</article>
						</section>
	...
	<script type="text/javascript"
		src="<c:url value='/resources/js/Buyer/mypage_infoModify.js?after'/>"></script>
	<script type="text/javascript"
