...
<link href="<c:url value='/resources/css/Common/sub_main.css?after'/>"
	rel="stylesheet" />
<link href="<c:url value='/resources/css/Buyer/mypage_main.css?after'/>"
	rel="stylesheet" />
<title>구매자페이지</title>
</head>
<body>
							...
							<article id="buyer__info">
								<div class="mypage__buyerRating">
									<div class="overall-rating">
										...
										<ul class="rating">
											...
											<li class="my_rating-grade"><h2 id="my-rating">LV.${user.grade}</h2>
												<a class="rating-benefit" href="BuyerMyPageMyGrade.by">등급
													혜택 보기</a></li>
											<li id="rating-explain"><p class="required-score">*
													다음 등급까지 ${rest_exp}점 남았습니다</p>
												<p class="register-date">가입일: ${user.joinDate}</p></li>
										</ul>
									</div>
								...
								<div class="mypage__subInfo">
									<div class="saving-point"
										onclick="location.href='BuyerMyPageSavePoint.by?status=전체'">
										<img src="./resources/Images/Buyer/Money.png"
											alt="saving point image" />
										<dl>
											<dt>적립금</dt>
									...
									<div class="write-review"
										onclick="location.href='BuyerMyPageReview.by'">
										<img src="./resources/Images/Buyer/wirte.png"
							...
							<article id="inquery">
								<div class="inquery__order-delivery">
									<div class="inquery--title">
										<h2>
											주문<span class="slash">/</span>배송조회
										</h2>
										<a class="view-all" href="BuyerMyPageOrderList.by"
											title="전체보기">전체</a>
									</div>
								...
								<table class="order__history--table">
									...
									<tbody>
										<c:if test="${fn:length(orderList) ==0 }">
											<tr>
												<td class="non-post" colspan="4">주문내역이 없습니다.</td>
											</tr>
											<tr>
												<td></td>
												<td></td>
										...
										<c:if test="${fn:length(orderList) >= 5}">
											<c:forEach var="list" items="${orderList}" end="5"
												varStatus="status">
												<tr>
													<td>${list.order_id}</td>
