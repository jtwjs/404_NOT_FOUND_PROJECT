												...
												<h2>상품만족</h2> <c:choose>
													<c:when test="${product_satis >= 3.5}">
														<div class="rating-grade excellent">
															<p>
																<strong>${product_satis}</strong> <span class="enter">우수</span>
															</p>
														</div>
													</c:when>
													<c:when test="${product_satis >= 2.5}">
														<div class="rating-grade warring">
															<p>
																<strong>${product_satis}</strong> <span class="enter">주의</span>
															</p>
														</div>
													</c:when>
													<c:otherwise>
														<div class="rating-grade bad">
															<p>
																<strong>${product_satis}</strong> <span class="enter">나쁨</span>
															</p>
														</div>
													</c:otherwise>
												</c:choose>
											...
											<li class="detail-rating--item">
												<h2>배송속도</h2> <c:choose>
													<c:when test="${delivery_satis >= 3.5}">
														<div class="rating-grade excellent">
															<p>
																<strong>${delivery_satis}</strong> <span class="enter">우수</span>
															</p>
														</div>
													</c:when>
													<c:when test="${delivery_satis >= 2.5}">
														<div class="rating-grade warring">
															<p>
																<strong>${delivery_satis}</strong> <span class="enter">주의</span>
															</p>
														</div>
													</c:when>
													<c:otherwise>
														<div class="rating-grade bad">
															<p>
																<strong>${delivery_satis}</strong> <span class="enter">나쁨</span>
															</p>
														</div>
													</c:otherwise>
												</c:choose>
