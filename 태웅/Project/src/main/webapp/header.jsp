	...
	<div id="header__content">
		<div class="header__top">
			<div class="inner">
				<sec:authorize access="isAnonymous()">
					<ul class="header__top__navi" id="non_navi">
						<li><a href="#" onclick="javascript:location.href='Login.ad'">로그인</a></li>
						<li><a href="#"
							onclick="javascript:location.href='JoinSelect.ad'">회원가입</a></li>
						<li><a href="#"
							onclick="javascript:location.href='OrderNonMember.or'">주문배송</a></li>
						<li><a href="#"
							onclick="javascript:location.href='BoardNotice.sc'">고객센터</a></li>
					</ul>
				</sec:authorize>
				<sec:authorize access="hasRole('ROLE_ADMIN')">
					<ul class="header__top__navi" id="admin_navi">
						<li><a href="#"
							onclick="document.getElementById('logout-form').submit();">로그아웃</a>
							<form id="logout-form" action='<c:url value='/logout.ad' />'
								method="POST">
								<input type="hidden" name="${_csrf.parameterName}"
									value="${_csrf.token}" />
							</form></li>
						<li><a href="#"
							onclick="javascript:location.href='AccountManagement.ad'">회원관리</a></li>
						<li><a href="#"
							onclick="javascript:location.href='BoardManagement.ad'">게시물관리</a></li>
						<li><a href="#"
							onclick="javascript:location.href='BoardNotice.sc'">고객센터</a></li>
					</ul>
				</sec:authorize>
				<sec:authorize access="hasRole('ROLE_BUYER')">
					<ul class="header__top__navi" id="buyer_navi">
						<li><a href="#"
							onclick="document.getElementById('logout-form').submit();">로그아웃</a>
							<form id="logout-form" action='<c:url value='/logout.ad' />'
								method="POST">
						...
						<li><a href="#"
							onclick="javascript:location.href='BuyerMyPage.by'">마이페이지</a></li>
						<li><a href="#" id="order_delivery">주문배송</a></li>
						<li><a href="#"
							onclick="javascript:location.href='CartView.or'">장바구니</a></li>
						<li><a href="#"
							onclick="javascript:location.href='BoardNotice.sc'">고객센터</a></li>
					</ul>
				</sec:authorize>
				<sec:authorize access="hasRole('ROLE_SELLER')">
					<ul class="header__top__navi" id="seller_navi">
						<li><a href="#"
							onclick="document.getElementById('logout-form').submit();">로그아웃</a>
							<form id="logout-form" action='<c:url value='/logout.ad' />'
								method="POST">
						...
						<li><a href="#"
							onclick="javascript:location.href='SellerMyPage.se'">마이페이지</a></li>
						<li><a href="#"
							onclick="javascript:location.href='BoardNotice.sc'">고객센터</a></li>
					</ul>
				</sec:authorize>
		...
		<nav id="header__nav" role="navigation">
			<div class="inner">
				<h2 id="header__logo">
					<a href="Index.in"> <img
						src="./resources/Images/module/header/main_logo.png" />
					</a>
				</h2>
					...
					<div id="category_menu">
						<div class="main_category">
							<ul id="main_category--list">
								<li><a id="main_category--first" class="title-on"
									href="BoardProductList.bo?category_1=1">쌀/잡곡</a></li>
								<li><a id="main_category--second"
									href="BoardProductList.bo?category_1=2">채소류</a></li>
								<li><a id="main_category--third"
									href="BoardProductList.bo?category_1=3">과일</a></li>
								<li><a id="main_category--fourth"
									href="BoardProductList.bo?category_1=4">축산물</a></li>
								<li><a id="main_category--fifth"
									href="BoardProductList.bo?category_1=5">수산물/건어물</a></li>
								<li><a id="main_category--sixth"
									href="BoardProductList.bo?category_1=6">가공식품/떡류</a></li>
								<li><a id="main_category--seventh"
									href="BoardProductList.bo?category_1=7">김치/반찬/젓갈</a></li>
								<li><a id="main_category--eighth"
									href="BoardProductList.bo?category_1=8">장/조청/식초</a></li>
								<li><a id="main_category--ninth"
									href="BoardProductList.bo?category_1=9">건강식품</a></li>
								<li><a id="main_category--tenth"
									href="BoardProductList.bo?category_1=10">차류</a></li>
							</ul>
						</div>
						<div class="sub_category">
							...
							<ul id="sub_category--second" class="hide">
								...
								<li><a href="BoardProductList.bo?category_2=203">나물/잎줄기
										채소</a></li>
							...
							<ul id="sub_category--tenth" class="hide">
								...
								<li><a href="BoardProductList.bo?category_2=1003">커피/차
										선물세트</a></li>
				...
				<div class="header__nav--localBar">
					<ul class="header__nav--list">
						<li class="nav--listItem listItem-title"><a
							href="BoardLocalIntroduce.bo">지역 특산물</a></li>
						<li class="nav--listItem"><a class="3"
							href="BoardProductList.bo?category_local=1">강원</a></li>
						<li class="nav--listItem"><a
							href="BoardProductList.bo?category_local=2">경기</a></li>
						<li class="nav--listItem"><a
							href="BoardProductList.bo?category_local=3">경북</a></li>
						<li class="nav--listItem"><a
							href="BoardProductList.bo?category_local=4">경남</a></li>
						<li class="nav--listItem"><a
							href="BoardProductList.bo?category_local=5">전북</a></li>
						<li class="nav--listItem"><a
							href="BoardProductList.bo?category_local=6">전남</a></li>
						<li class="nav--listItem"><a
							href="BoardProductList.bo?category_local=7">충북</a></li>
						<li class="nav--listItem"><a
							href="BoardProductList.bo?category_local=8">충남</a></li>
						<li class="nav--listItem"><a
							href="BoardProductList.bo?category_local=9">제주</a></li>
						<li class="nav--listItem"><a
							href="BoardProductList.bo?category_local=10">울릉도/독도</a></li>
					</ul>
				</div>
				<div class="header__nav--searchbar">
					...
					<button type="button" class="search-btn"
						onclick="boardProductSearch();">
						<img src="./resources/Images/module/header/search-icon.png"
							alt="search icon" />
					</button>
				</div>
		</nav>
...
<div class="delivery-modal-bg hide">
	<div class="delivery-modal">
		...
		<div class="modal-content">
			...
			<div class="modal-btn">
				<a class="go_shopping-btn" href="Index.in">쇼핑하러가기</a> <a
					class="past_orderList-btn" href="BuyerMyPageOrderList.by">지난
					주문내역 보러가기</a>
			</div>
		</div>
	</div>
